...
const Contact: React.FC = () => {
  ...
  const sendContact = () => {
    const nameInput = document.getElementById('nameHelp') as HTMLInputElement;
    const emailInput = document.getElementById('emailHelp') as HTMLInputElement;
    const messageTextarea = document.getElementById('messageHelp') as HTMLTextAreaElement;
      ...
      <div id="contactDataHelpWrapper">
        <div id='contactDataHelp'>
          ...
          <div id='contactDataImgsHelp'>
            <a href='https://t.me/asteroid_shop_proj' target='_blank' rel='noopener noreferrer'>
              <img src={telegramLogo} alt='Telegram' />
            </a>
            <a href='https://github.com/Uvoi/AsteroidShop' target='_blank' rel='noopener noreferrer'>
              <img src={githubLogo} alt="GitHub" />
            </a>
            <a href='https://vk.com/asteroid_shop_proj' target='_blank' rel='noopener noreferrer'>
